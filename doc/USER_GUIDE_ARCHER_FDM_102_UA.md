...
* **Модель запису** - вид зображення на запису.
    - Стан: <img src="/doc/media/image19.png" alt="image" width="24"></p> (або, якщо застосовується канал 3, або обидва, тоді) <img src="/doc/media/image21.png" alt="image" width="24">
...
* **Режим відображ.** - можливі моделі зображення, що вмикаються кнопкою «Режим».
    - Стан: <img src="/doc/media/image21.png" alt="image" width="24">
