...
* **Модель запису** - вид зображення на запису.
    - Стан: <img src="/doc/media/image19.png" alignment="center" alt="image" width="32" height="32">
    (або, якщо застосовується канал 3, або обидва, тоді)
    <img src="/doc/media/image20.png" alignment="center" alt="image" width="32" height="32">
...
* **Режим відображ.** - можливі моделі зображення, що вмикаються кнопкою «Режим».
    - Стан: <img src="/doc/media/image20.png" alignment="center" alt="image" width="32" height="32">
...
- налаштування параметрів по п.2.3.2. 
